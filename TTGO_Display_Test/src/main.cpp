...
void analogMeter()
{
  ...
  // Meter outline
  tft.fillRect(0, 0, 239, 131, TFT_GREY);
  tft.fillRect(1, 3, 234, 125, TFT_WHITE);
  ...
  tft.drawString("Km/h", (3 + 230 - 40), (119 - 20), 2); // Units at bottom right
  tft.drawCentreString("Km/h", 120, 75, 4); // Comment out to avoid font 4
  tft.drawRect(1, 3, 236, 126, TFT_BLACK); // Draw bezel line
...
void plotNeedle(int value, byte ms_delay)
{
  ...
  char buf[8]; 
    ...
    tft.drawRightString(buf, 33, (119 - 20), 2);
    ...
    while (!(value == old_analog)) 
    {
        ...
        tft.drawLine((120 + 24 * ltx) - 1, (150 - 24), osx - 1, osy, TFT_WHITE);
        tft.drawLine((120 + 24 * ltx), (150 - 24), osx, osy, TFT_WHITE);
        tft.drawLine((120 + 24 * ltx) + 1, (150 - 24), osx + 1, osy, TFT_WHITE);
